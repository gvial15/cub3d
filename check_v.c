...
/*   Updated: 2023/04/17 12:08:29 by mjarry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	loop_check_v(t_cub3d *cub3d, t_rays *ray, float theta)
{
	...
	{
		ray->v_wall_found = check_l(cub3d, ray, \
		ray->v_check[0] + ray->x, ray->v_check[1] + ray->y);
...
void	check_vertical(t_cub3d *cub3d, t_rays *ray)
{
	...
	if (!ray->v_wall_found && ray->v_check[0] != (float)0
		&& ray->v_check[1] != (float)0)
